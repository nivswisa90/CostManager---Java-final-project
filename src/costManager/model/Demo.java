...
//                    "currency varchar(250),description varchar(250),date varchar(256), FOREIGN KEY (categoryId) REFERENCES categories(id))");
            ...
            CostItem item = new CostItem(15, categoryList.get(0),14.33, Currency.EURO,"test4","20-12-2020");
